...
def create_prompt(categories, cfg, tokenizer, model, img_paths):
    ...
    prompt_dict = {
        'color': f'What is the color of this wound?',
        'shape': f'What is the shape of this wound?',
        #'location': f'what organ is this wound located on?',
    }
    with open('/root/projects/vl/VL-model-medical-image-understanding/prompt_dfuc_logs.txt', 'a+') as f:
        ...
        f.writelines(f'location: What organ is this wound located on?')
    ...
    for img_path in img_paths:
        ...
        caption = f'{color} color, {shape} shape ulcer in foot'
